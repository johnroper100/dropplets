...
$language = [
    "en_US" => [
        ...
        "settings_blog_image" => "OpenGraph Image:",
        "settings_blog_image_placeholder" => "Enter a URL to an image you'd like displayed on social media sites",
    ...
    "fr_FR" => [
        ...
        "settings_blog_image" => "Ouvrir graphique Image:",
        "settings_blog_image_placeholder" => "Entrez une URL vers une image que vous souhaitez afficher sur les sites de médias sociaux",
